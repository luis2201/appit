...
<body class="bg-gradient-primary">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-2">
                                ...
                                <?php //echo Main::encryption('1314173921'); ?>
                                <form id="form" method="post" class="user">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="correo_electronico" name="correo_electronico" placeholder="Ej: alguien@example.com">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="text-center">
                                    <a class="small" href="register">Aún no te has registrado?</a>
                                </div>
                                <div class="text-center">
    ...
    <script src="functions/login.js?v=1.0.0"></script>
