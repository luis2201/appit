...
async function compruebaDatosPersonales()
{
  ...
  await axios.get('https://appit.itsup.edu.ec/admisiones/datospersonales/find/' + idadmisiones)
...
async function buscaAdmision()
{
  ...
  await axios.post('https://appit.itsup.edu.ec/admisiones/inscripcion/find/', params)
  .then(async function (res) {
    let info = res.data[0];
  ...
  $.confirm({
    ...
    buttons: {
      ...
      aceptar: async function () {
        ...
        await axios.post('https://appit.itsup.edu.ec/admisiones/inscripcion/insert', formData)
        .then(function (res) {
          $.confirm({
            title: 'Admisiones',
