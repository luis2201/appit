<?php
  ...
  class DatospersonalesController
  {
    ...
    public static function find($idadmisiones)
    {
      ...
      $resp         = Datospersonales::find($idadmisiones);

      $datospersonales  = new Datospersonales();
      $datospersonales->idadmisiones            = Main::encryption($resp->idadmisiones);
    ...
    public function edit()
    {
      ...
      $idadmisiones            = Main::decryption($_POST['idadmisiones']);
      ...
      $datospersonales = new Datospersonales();
      $datospersonales->idadmisiones             = $idadmisiones;
