...
<body>
    ...
    <main class="container mt-2">
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <h5 style="font-weight: bold;">Stands a calificar</h5>
            </div>
            <hr>
            <?php
            ...
            <div class="row">
                <div class="col-10" style="margin: auto;">
                    <div class="row">
                        <div class="col-8">
                            <a class="btn btn-primary btn-md mb-2" href="asistencias.php?id=<?php echo $row->idstand; ?>" style="width:100%">Stand <?php echo $row->nombre; ?></a>
                        </div>
                        <div class="col-4">
