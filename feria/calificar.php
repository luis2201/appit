...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="calificar.php">Calificar</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container mt-2">
        ...
        <div class="col-md-6 offset-md-3">
                <h4 style="font-weight: bold;">Lista de Stands a calificar</h4>
                <hr>
            <?php
                $params = [":idusuario" => $_SESSION["idusuario"]];
                $result = Stands::findStands($params);
            ...
            ?>
                <div class="row">
                    <div class="col-10" style="margin: auto;">
                        <div class="row">
                            <div class="col-8">
                                <button class="btn btn-primary btn-md mb-2" style="width:100%">Stand <?php echo $row->nombre; ?></button>
                            </div>
                            <div class="col-4">
                                <input type="text" class="form-control text-center" disabled value="<?php echo $row->visitantes ?>">
                            </div>
                        </div>
                    </div>
                </div>
