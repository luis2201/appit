var rowstb = document.getElementById("rows");
...
cmbIdPeriodo.addEventListener("change", async function(){
    ...
    await axios.post('https://appit.itsup.edu.ec/ceie/certificadosuficiencia/findallestudiantessuficiencia/', {
        idperiodo
    })
    .then(function (res){
        let rows = res.data;
console.log(rows)
        rowstb.innerHTML = rows;
    })
});
