...
function inscripcion(idmatricula) {
    $.confirm({
        ...
        content: 'Desea realizar la inscripción del/la estudiante para el examen de Suficiencia?',
        theme: 'modern',
        type: 'blue',
        typeAnimated: true,
        buttons: {
          aceptar: async function () {
            ...
            await axios.post(DIR + 'examensuficiencia/insert/', {
                idperiodo,
                idmatricula
            })
            .then(function (res){
                ...
                if(info){
                    $.alert({
                        ...
                        content: 'Inscripción realizada de forma satisfactoria',
                        theme: 'modern',
                        type: 'blue',
                        typeAnimated: true,
                        buttons: {
                          aceptar: function () {
                            cargaLista(document.getElementById("cmbidperiodo").value);
                          }
                        }
                    });
                } else{
                    $.alert({
                        ...
                        content: 'No fue posible realizar la acción solicitada. Vuelva a intentar',
                        theme: 'modern',
                        type: 'red',
                        typeAnimated: true,
                        buttons: {
