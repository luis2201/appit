...
btnMostrar.addEventListener("click", async function(){
    ...
    await axios.post('https://appit.itsup.edu.ec/ceie/calificacionsuficiencia/viewlistaestudiante/', {
        idperiodo
    })
    .then(function (res){
        let rows = res.data;
...
async function focusOut(input)
{
    ...
    await axios.post("https://appit.itsup.edu.ec/ceie/calificacionsuficiencia/save", {
    ...
    // await axios.post('https://appit.itsup.edu.ec/ceie/registrocalificacion/viewlistaestudiante/', {
    //     idperiodo,
    //     idmodulo
    // })
    // .then(function (res){
