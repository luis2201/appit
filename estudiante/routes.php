...
include_once "models/Ceie.php";
include_once "models/Actualizarfoto.php";
include_once "models/Calificacionceie.php";
...
if(!isset($_SESSION['idestudiante_appit']) && $controller != "Register"){
    $controller = "login";
}
