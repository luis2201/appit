...
cmbIdDocente.addEventListener("change", async function ()
{
  ...
  if(cmbIdDocente.value != "") {
    await axios.post('https://appit.itsup.edu.ec/secretaria/docente/finddocentemateriapresencial/', {
        idperiodo,
        iddocente
    })
    .then(function (res){
...
btnMostrar.addEventListener("click", async function (){
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/cuadrodocente/viewlistaestudiantemateria/', {
    idperiodo,
    idmateria,
    idparcial
  })
