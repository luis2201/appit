...
cmbIdCarrera.addEventListener('change', async function () {
  ...
  if(cmbIdCarrera.value != "") {
    await axios.post('https://appit.itsup.edu.ec/secretaria/nivel/findcursoidcarreravirtual/',{
      idperiodo,
      idcarrera
    })
    .then(function (res){
...
btnMostrar.addEventListener("click", async function (){
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/enlineacalificaciontotal/viewlistaestudiantemateria/', {
    idperiodo,
    idmateria
  })
  .then(function (res){   
...
async function total(input)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/enlineacalificaciontotal/insertcalificacion/', {
    idperiodo,
    idmatricula,
    idcarrera,    
    idnivel,
...
async function cargarCalificacion(idmatricula)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/enlineacalificaciontotal/findcalificacionidmatricula/',{
    idmatricula, 
    idperiodo,
    idmateria
  })
