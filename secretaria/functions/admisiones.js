...
async function rechazar(iddetalle_admision)
{
  $.confirm({
    title: 'Rechazar postulación',
    icon: 'fa fa-exclamation-triangle',
    content: 'Se procederá a rechazar la postulación de Nivelación y se notificará al estudiante. No se podrán deshacer los cambios realizados. Desea continuar?',
    theme: 'modern',
    type: 'red',
    typeAnimated: true,
    buttons: {
...
async function aprobar(iddetalle_admision)
{
  $.confirm({
    title: 'Aprobar solicitud',
    icon: 'fa fa-info-circle',
    content: 'Se procederá a aprobar la postulación de Nivelación. Desea continuar?',
    theme: 'modern',
    type: 'blue',
    typeAnimated: true,
    buttons: {
