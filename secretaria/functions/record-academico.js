...
cmbIdPeriodo.addEventListener("change", async function(){
  ...
  if(cmbIdPeriodo.value != "") {
    await axios.get('https://appit.itsup.edu.ec/secretaria/carrera/findcarreraperiodopresencial/' + idperiodo )
    .then(function (res){
      let info = res.data;
...
cmbIdCarrera.addEventListener("change", async function(){  
  ...
  if(cmbIdCarrera.value != "") {
    ...
    await axios.post('https://appit.itsup.edu.ec/secretaria/seccion/findseccionidcarreraspresencial/', {
      idperiodo,
      idcarrera
    })
    .then(function (res){
...
cmbIdSeccion.addEventListener("change", async function(){    
  ...
  if(cmbIdSeccion.value != "") {
    ...
    await axios.post('https://appit.itsup.edu.ec/secretaria/modalidad/findmodalidadseccioncarreras/', {
      idperiodo,
      idcarrera,
      idseccion
    })
...
cmbModalidad.addEventListener("change", async function(){      
  ...
  if(cmbModalidad.value != "") {
    ...
    await axios.post('https://appit.itsup.edu.ec/secretaria/nivel/findnivelseccioncarreramodalidades/', {
      idperiodo,
      idcarrera,
      idseccion,
      modalidad
...
btnLista.addEventListener("click", async function(){
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/record/viewlista', {
    idperiodo,
    idcarrera,
    idseccion,
    modalidad,
