...
$("document").ready(async function(){
    ...
    await axios.get('https://appit.itsup.edu.ec/secretaria/tutor/findall/' + idperiodo)
    .then(function (res){
      let info = res.data;
...
async function cargaCarrera(iddocente)
{
  ...
  if(IdDocente.value != "") {
    await axios.post('https://appit.itsup.edu.ec/secretaria/carrera/findcarreradocente/', {
        idperiodo,
        iddocente
    })
    .then(function (res){
...
cmbModalidad.addEventListener('change', async function () {
  ...
  if(cmbModalidad.value != "") {
    await axios.post('https://appit.itsup.edu.ec/secretaria/docente/finddocentecarreracurso/', {
      idperiodo,
      idcarrera,
      iddocente
    })
...
form.addEventListener("submit", async function(event){
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/tutor/inserttutor/', {
    idperiodo,
    iddocente,
    idcarrera,
    idnivel,
