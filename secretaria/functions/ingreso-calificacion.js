...
btnMostrar.addEventListener("click", async function (){
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/ingresocalificacion/viewlistaestudiantemateria/', {
    idperiodo,
    idmateria
  })
  .then(function (res){   
...
async function total(input)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/ingresocalificacion/insertcalificacion/', {
    idperiodo,
    idmatricula,
    idcarrera,    
    idnivel,
...
async function cargarCalificacion(idmatricula)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/ingresocalificacion/findcalificacionidmatricula/',{
    idmatricula, 
    idperiodo,
    idmateria,
    idparcial
