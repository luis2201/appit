...
cmbIdPeriodo.addEventListener("change", async function(){
  ...
  if(cmbIdPeriodo.value != "") {
    await axios.get('https://appit.itsup.edu.ec/secretaria/carrera/findcarreraperiodovalidacion/' + idperiodo )
    .then(function (res){
      let info = res.data;
...
cmbIdCarrera.addEventListener("change", async function(){  
    ...
    if(cmbIdCarrera.value != "") {
        ...
        await axios.post('https://appit.itsup.edu.ec/secretaria/nivel/findnivelcarreravalidacion/', {
            idperiodo,
            idcarrera
        })
        .then(function (res){
...
btnLista.addEventListener("click", async function(){
  ...
  await axios.post('https://appit.itsup.edu.ec/secretaria/recordvalidacion/viewlista', {
    idperiodo,
    idcarrera,
    idnivel
  })
