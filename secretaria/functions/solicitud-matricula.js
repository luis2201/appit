...
{
  await axios.get('https://appit.itsup.edu.ec/secretaria/solicitudmatricula/findcedula' + numero_identificacion)
  .then(function (res) {
    let info = res.data[0];
  ...
  $.confirm({
    ...
    buttons: {
      aceptar: async function () {
        await axios.get('https://appit.itsup.edu.ec/secretaria/solicitudmatricula/inconsistenciadatos' + numero_identificacion)
        .then(function (res) {
...
async function rechazar(idmatricula)
{
  $.confirm({
    ...
    buttons: {
      aceptar: async function () {
        await axios.get('https://appit.itsup.edu.ec/secretaria/solicitudmatricula/rechazarmatricula/' + idmatricula)
        .then(function (res) {
          console.log(res);
          window.location.reload();
        })
