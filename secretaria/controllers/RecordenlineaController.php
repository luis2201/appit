<?php
    ...
    class RecordenlineaController
    {
        public function index()
        {
            $periodo = Periodo::findActivo();

            view("recordenlinea.index", ["periodo" => $periodo]);
        }
        ...
        public function viewlista()
        {
            ...
            $res = Listasniveles::viewListaEnLinea($idperiodo, $idcarrera, $idnivel);
            $rows = '';
            $i = 1;
            ...
            foreach ($res as $row) {
                ...
                $rows.='<tr id="'.Main::encryption($row->idmatricula).'">
                            ...
                            <td>
                                <a href="recordacademicoenlinea/'.$encryp.'" class="btn btn-primary" target="_blank"><i class="fas fa-eye"></i></a>
                            </td>      
                        </tr>';
            }
