      ...
      <div class="container-fluid">
        ...
        <div aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Solicitud de Matrícula Validación</li>
          </ol>
        </div>
          ...
          <div class="card-body">
            <table id="tbLista" class="table table-striped" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
              ...
              <tbody style="font-size:0.8em">
                <?php
                $solicitudes = Solicitudvalidacion::findall();
      ...
      <script src="<?php echo DIR; ?>functions/solicitud-validacion.js"></script>
      </body>
