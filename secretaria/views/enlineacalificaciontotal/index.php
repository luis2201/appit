        ...
        <div class="modal-dialog modal-fullscreen">
          <div class="modal-content">            
            <div class="modal-body">
              <!-- Tabla de resultados -->
              <div id="tbLista" class="col-8" style="margin:auto">
                <div class="row">
                  ...
                  <table id="tbCuadro" class="table table-stripped table-responsive" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px; margin-top: -20px;">
                    <thead class="bg-primary text-light text-center">
                      <tr style="height: 20px; font-weight: bold;">
                        ...
                        <td scope="col" class="text-center align-middle">CALIFICACIÓN</td>
...
<script src="<?php echo DIR; ?>functions/global.js?v=1.0.00"></script>
<script src="<?php echo DIR; ?>functions/enlineacalificacion-total.js?v=1.0.3"></script>
</body>
<style>
