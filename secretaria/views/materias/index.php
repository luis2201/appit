...
<div class="container-fluid">
  ...
  <div aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Registro de Materias</li>
    </ol>
  </div>
        ...
        <table id="tbLista" class="table table-stripped">
          <thead>
            <tr>
              ...
              <th scope="col" class="text-center">Concatenada</th>
          ...
          <tbody>
            ...
            <tr>
                <th class="text-center" scope="row"><?php echo $row->idmateria; ?></th>
                <td class="text-center"><?php echo $row->codigo; ?></td>
                <td><?php echo $row->materia; ?></td>
                <td><?php echo $row->concatenada; ?></td>
                <td class="text-center"><?php echo $row->creditos; ?></td>
...
<script src="<?php echo DIR; ?>functions/materias.js"></script>
</body>
