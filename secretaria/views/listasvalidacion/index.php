...
<div class="container-fluid">
  ...
  <div aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Listas Validación por Niveles y Carreras</li>
    </ol>
  </div>
          ...
          <div class="col-md-3">
            ...
            <select name="idnivel" id="idnivel" class="form-select">
              ...
              foreach ($niveles as $row) :
                if($row->idnivel >= 12 && $row->idnivel <= 14){
              ?>
              ...
              <div id="tbLista">
                <div class="row">
                  <div class="col-12 mb-2 text-center">
                    ...
                    <h6>Periodo Académico: Noviembre 2022-Abril 2023</h6>
                  </div>
                </div>
                <div class="row">
                  <div class="col-6">
...
<script src="<?php echo DIR; ?>functions/listas-validacion.js"></script>
