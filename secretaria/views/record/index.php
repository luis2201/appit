...
<div class="container-fluid">
  ...
  <div aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#">Record Académico</a></li>
      <li class="breadcrumb-item active" aria-current="page">Generar Record Académico</li>
    </ol>
  </div>
...
<script src="<?php echo DIR; ?>functions/record-academico.js?v=1.0.7"></script>
<style>
  #certificacion{
    width: 21cm;
    min-height: 29.7cm;
