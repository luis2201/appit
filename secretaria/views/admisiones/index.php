        ...
        <div class="card border-bottom-primary">
          ...
          <div class="card-body">
            <table id="tbLista" class="table table-striped" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
              ...
              <tbody>
                <?php
                $solicitudes = Admisiones::findall(21);
                foreach ($solicitudes as $row) :
                ?>
                  <tr>
                    <td scope="col"><?php echo $row->iddetalle_admision; ?></td>
                    ...
                    <td class="text-center">
                      <button id="btnAceptar" class="btn btn-circle btn-sm btn-primary" title="Validar Matrícula" value="<?php echo $row->iddetalle_admision; ?>" onclick="aprobar(this.value);"><i class="fa fa-check-square" aria-hidden="true"></i></button>
                      <button id="btnRechazar" class="btn btn-sm btn-danger" title="Rechazar postulación" value="<?php echo $row->iddetalle_admision; ?>" onclick="rechazar(this.value);"><i class="fa fa-ban" aria-hidden="true"></i></button>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
