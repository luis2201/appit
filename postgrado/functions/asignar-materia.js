...
btnVerLista.addEventListener("click", async function (){
    ...
    await axios.post('https://appit.itsup.edu.ec/postgrado/estudiante/findestudianteidcarrera', {
        idperiodo,
        idcarrera
      })
    .then(function (res) {
        ...
        document.getElementById("estudiantes").innerHTML = estudiantes;
    })
...
async function agregaMaterias(estudiante)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/postgrado/materiaintroductorio/findmateriaidcarrera', {
    idcarrera,
    idmatricula
  })
  .then(function (res) {
      ...
      document.getElementById("materias").innerHTML = estudiantes;
  })
  .catch(function (error) {
      $.confirm({
          title: 'Acceso no autorizado',
...
async function saveMaterias(check)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/postgrado/asignarmateria/savemateria', {
    idmatricula,  
    idmateria,
    isChecked
  })
