...
cmbIdCarrera.addEventListener("change", async function (e) {
  ...
  await axios.post('https://appit.itsup.edu.ec/financiero/pagomatricula/findnivelcarrera', {
    idperiodo,
    idcarrera
  })
  .then(function (res){
...
cmbIdNivel.addEventListener("change", async function (e) {
  ...
  await axios.post('https://appit.itsup.edu.ec/financiero/pagomatricula/findnivelcarreraseccion', {
    idperiodo,
    idcarrera,
    idnivel
  })
...
frmNuevo.addEventListener('submit', async function (e) {
  ...
  let res = await axios.get('https://appit.itsup.edu.ec/financiero/pagomatricula/findidentificacion/' + numero_identificacion);
  ...
  res = await axios.post('https://appit.itsup.edu.ec/financiero/pagomatricula/findcorreo/', {correo_electronico});
  ...
  await axios.post('https://appit.itsup.edu.ec/financiero/pagomatricula/insert/', formData)
...
{  
  ...
  await axios.get('https://appit.itsup.edu.ec/financiero/pagomatricula/findestudianteid/' + idestudiante)
  .then(async function (res) {
    ...
    res = await axios.post('https://appit.itsup.edu.ec/financiero/pagomatricula/findpagomatricula/',{
      idestudiante,
      idperiodo
    });
    ...
    res = await axios.get('https://appit.itsup.edu.ec/financiero/pagomatricula/finddetalleidpago/' + idpagomatricula);
...
async function mostrarCalificaciones(idestudiante){  
  ...
  res = await axios.post('https://appit.itsup.edu.ec/financiero/matricula/modalidadmatricula/',{
    idestudiante,
    idperiodo
  });
  ...
  if(modalidad != 'Virtual'){
    ...
    await axios.post('https://appit.itsup.edu.ec/financiero/promocion/viewcalificacion', {
      idperiodo,
      idestudiante,
    })
    .then(function (res){   
    ...
    await axios.post('https://appit.itsup.edu.ec/financiero/promocion/viewcalificacionenlinea', {
      idperiodo,
      idestudiante,
    })
    .then(function (res){   
...
frmPago.addEventListener('submit', async function (e) {
  ...
  if(saldo == 0 && valorpago > valormatricula){
    ...
    await axios.post('https://appit.itsup.edu.ec/financiero/pagomatricula/insertpago/', formData)
    .then(function (res){
      let info = res.data;
...
async function valorMatricula(tipo_matricula)
{
  ...
  await axios.get('https://appit.itsup.edu.ec/financiero/pagomatricula/findvalormatricula/' + idperiodo )
  .then(function (res) {
    let info = res.data;
