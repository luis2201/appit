...
frmNuevo.addEventListener('submit', async function (e) {
    ...
    let res = await axios.get('https://appit.itsup.edu.ec/financiero/pagoadmisiones/findidentificacion/' + numero_identificacion);
    ...
    res = await axios.post('https://appit.itsup.edu.ec/financiero/pagoadmisiones/findcorreo/', {correo_electronico});
    ...
    await axios.post('https://appit.itsup.edu.ec/financiero/pagoadmisiones/insert/', formData)
...
async function seleccionar(idadmisiones)
{
  ...
  await axios.get('https://appit.itsup.edu.ec/financiero/pagoadmisiones/findadmisionesid/' + idadmisiones)
  .then(async function (res) {
    ...
    res = await axios.post('https://appit.itsup.edu.ec/financiero/pagoadmisiones/findpagoadmisiones/',{
      idadmisiones,
      idperiodo
    });
...
frmPago.addEventListener('submit', async function (e) {
    ...
    if(valorpago > valorpagar){
      ...
      await axios.post('https://appit.itsup.edu.ec/financiero/pagoadmisiones/insertpago/', formData)
      .then(function (res){
        let info = res.data;
        /****************************************************** */
        $.confirm({
