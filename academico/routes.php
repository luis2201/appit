...
include_once "models/Reporteasistencia.php";
include_once "models/Cargahoraria.php";
include_once "models/Tutor.php";
include_once "models/Materias.php";
include_once "models/Materiasintroductorio.php";
include_once "models/Materiasperfil.php";
include_once "models/Cargahorariaintroductorio.php";
...
if(!isset($_SESSION['idusuario_appit']) || $_SESSION['tipousuario_appit']!= 'ACADEMICO'){
    $controller = "login";
}
