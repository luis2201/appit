...
cmbIdCarrera.addEventListener("change", async function(){
  ...
  if(cmbIdCarrera.value != "") {
    await axios.post('https://appit.itsup.edu.ec/academico/docente/findprofesorcarrera/', {
      idperiodo, 
      idcarrera
    })
    .then(function (res){
...
cmbIdDocente.addEventListener("change", async function(){
  ...
  if(cmbIdDocente.value != "") {
    await axios.post('https://appit.itsup.edu.ec/academico/materias/finddocentematerias/', {
      idperiodo, 
      idcarrera,
      iddocente
    })
...
form.addEventListener('submit', async function (e)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/academico/reporteasistencia/viewlistaestudiantes', {
    idperiodo,
    idmateria
  })
  .then(function (res) {
