...
btnBuscarM.addEventListener("click", async function () {
    ...
    await axios.post('https://appit.itsup.edu.ec/academico/cargahoraria/findmateriamalla/', {
        idperiodo,
        idcarrera,
        idnivel
    })
...
form.addEventListener("submit", async function(e)
{
    ...
    let valida = await axios.post('https://appit.itsup.edu.ec/academico/cargahoraria/validacarga/', formData);
    ...
    await axios.post('https://appit.itsup.edu.ec/academico/cargahoraria/insert', formData)
    .then(function(res) {
        let info = res.data;
        $.confirm({
            title: 'Información del Sistema',
...
async function cargaMateriaDocente(data)
{
    ...
    const idperiodo = document.getElementById("idperiodo").value; 
    let iddocente = document.getElementById("iddocente").value;
    await axios.post('https://appit.itsup.edu.ec/academico/cargahoraria/totalhorasdocente/', {
        iddocente,
        idperiodo
    })
    .then(function (res) {
