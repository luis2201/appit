...
$("document").ready(async function(){
    ...
    await axios.get('https://appit.itsup.edu.ec/academico/tutor/findall/' + idperiodo)
    .then(function (res){
      let info = res.data;
...
async function cargaCarrera(iddocente)
{
  ...
  if(IdDocente.value != "") {
    await axios.post('https://appit.itsup.edu.ec/academico/carrera/findcarreradocente/', {
        idperiodo,
        iddocente
    })
    .then(function (res){
...
cmbIdCarrera.addEventListener('change', async function () 
{
  ...
  if(cmbIdCarrera.value != "") {
    await axios.get('https://appit.itsup.edu.ec/academico/seccion/findseccionidperiodo/' + idperiodo )
    .then(function (res){
      let info = res.data;
...
cmbModalidad.addEventListener('change', async function () {
  ...
  if(cmbModalidad.value != "") {
    await axios.post('https://appit.itsup.edu.ec/academico/docente/finddocentecarreracurso/', {
      idperiodo,
      idcarrera,
      iddocente
    })
...
form.addEventListener("submit", async function(event){
  ...
  await axios.post('https://appit.itsup.edu.ec/academico/tutor/inserttutor/', {
    idperiodo,
    iddocente,
    idcarrera,
    idnivel,
