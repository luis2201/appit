...
<div class="container-fluid">
  ...
  <div aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Carga Horarioa Materias del Perfil Introductorio</li>
    </ol>
  </div>
  ...
  <div class="container-fluid border-dark">
    <div class="card border-bottom-primary">
      <div class="card-header bg-gradient-primary text-light">
        ...
        <button id="btnAgregar" class="btn btn-success float-end"><i class="fas fa-plus"></i> Agregar/Modificar Carga Horaria Materias del Perfil</button>
      </div>
      <div class="card-body">
        <div class="card mt-2 p-2">
          <table id="tbLista" class="table table-stripped" style="width:100%">
            ...
            <tbody>
              <?php $i = 1; ?>
              <?php foreach($cargahoraria as $row): ?>
                <tr>
                  <td style="width:5%"><?php echo $i++; ?></td>
                  <td style="width:30%"><?php echo $row->docente; ?></td>
                  <td style="width:30%"><?php echo $row->carrera; ?></td>
                  <td style="width:35%"><?php echo $row->materia; ?></td>
                </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
            ...
            <div class="row mt-2">
                <div class="col">
                  <label >Docente</label>
                  <div id="docentes" style="overflow:scroll; height:300px">
...
<script src="<?php echo DIR; ?>functions/Cargahorariaintroductorio.js?v=1.1.9"></script>
</body>
