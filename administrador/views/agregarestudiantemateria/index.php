...
<!-- Modal -->
<div class="modal fade" id="modalEstudiantes" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalEstudiantesLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalEstudiantesLabel">Agregar/Eliminar Materias</h5>
      ...
      <div class="modal-body">
        ...
        <div id="tbEstudiantes" class="row" style="height:25%">
...
<script src="<?php echo DIR; ?>functions/agregar-estudiantemateria.js?v=1.1.4"></script>
</body>
