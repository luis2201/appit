...
function editDatos(button) {
    var row = button.closest('tr');
    var cells = row.getElementsByTagName('td');

    var idestudiante = button.id;
    var numero_identificacion = cells[1].textContent;
    var apellidos = cells[2].textContent;
    var nombres = cells[3].textContent;
    var correo_electronico = cells[4].textContent;

    document.getElementById("idestudiante").value = idestudiante;
    document.getElementById("modalTitleId").innerText = apellidos +' '+nombres;
...
const btnUpdateDatos = document.getElementById("btnUpdateDatos"); 
btnUpdateDatos.addEventListener("click", async function(){
