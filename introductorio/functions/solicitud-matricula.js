...
async function compruebaDatosPersonales()
{
  ...
  await axios.get('https://appit.itsup.edu.ec/estudiante/datospersonales/find/' + idestudiante)
...
async function datosMatricula(){
  ...
  await axios.post('https://appit.itsup.edu.ec/estudiante/solicitudmatricula/findmatriculaidestudiante/', params)
  .then(function (res) {
    let info = res.data[0];
...
async function buscaMatricula()
{
  ...
  await axios.post('https://appit.itsup.edu.ec/estudiante/solicitudmatricula/find', params)
  .then(async function (res) {
    let info = res.data[0];
    ...
    if(info.idmatricula >=1){
      ...
      const res = await axios.post('https://appit.itsup.edu.ec/estudiante/carrera/findcarrera', params);
      info = res.data;
...
//         // await axios.post('https://appit.itsup.edu.ec/estudiante/solicitudmatricula/insert', formData)
//         // .then(function (res) {
//         //   console.log(res)
//         //   $.confirm({
//         //     title: 'Registro de matrícula',
...
async function getMateriasAll(idperiodo, idcarrera)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/estudiante/materia/find', params)
  .then(async function (response) {
    ...
    for (let i = 0; i < materias.length; i++) {
      ...
      const res = await axios.post('https://appit.itsup.edu.ec/estudiante/materia/finddetallematricula', params)
      info = res.data[0];
      if(res.data.length == 0) {
...
async function agregaDetalleMatricula(idmateria)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/estudiante/detallematricula/insert', params)
