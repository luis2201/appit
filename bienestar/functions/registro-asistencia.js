...
cmbIdCarrera.addEventListener('change', async function () {
  ...
  if(cmbIdCarrera.value != "") {
    await axios.post('https://appit.itsup.edu.ec/bienestar/materia/findmateriaperiodocarrera/', {
      idperiodo,
      idcarrera
    })
    .then(function (res){
...
btnMostrar.addEventListener('click', async function ()
{
  ...
  await axios.post('https://appit.itsup.edu.ec/bienestar/registroasistencia/viewlistaestudiantemateria/', {
    idperiodo,
    idcarrera,    
    idmateria,
    fecha
...
async function justificar(idasistencia)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/bienestar/registroasistencia/justificartarea/', {
    idperiodo,
    idcarrera,
    idmateria,
    fecha,
