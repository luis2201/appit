...
async function mostrar(idmatricula){
    ...
    await axios.post('https://appit.itsup.edu.ec/bienestar/reporteasistencia/findfaltasfecha/', {
      idmateria,
      idmatricula
    })
    .then(function (res){
...
btnMostrar.addEventListener('click', async function ()
{
  ...
  await axios.post('https://appit.itsup.edu.ec/bienestar/reporteasistencia/viewlistaestudiantemateria/', {
    idperiodo,
    idcarrera,    
    idmateria
  })
