    ...
    class AsistenciaController
    {
        ...
        public function findlistamaterias()
        {
            ...
            foreach($resp as $row){
                ...
                $pinasistencia = ($pinasistencia>=25)?'<td scope="col" class="text-center text-danger font-weight-bolder">'.$pinasistencia.'%</td>':'<td scope="col" class="text-center">'.$pinasistencia.'%</td>';
                $rows .= '<tr>
                            ...
                            <td scope="col" class="text-center">'.$pasistencia.'%</td>
                            '.$pinasistencia.'
