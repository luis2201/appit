<?php
  ...
  class Datospersonales extends DB
  {
    ...
    {
        $db = new DB();
        $prepare = $db->prepare("call sp_estudiante_select_id(:idestudiante)");
    ...
    public function edit()
    {
        ...
        $prepare = $this->prepare("call sp_estudiante_update(:idestudiante, :fecha_nacimiento, :apellido1, :apellido2, :nombre1, :nombre2, :sexo, :genero, :estado_civil, :etnia, :tipo_sangre, :discapacidad, :porcentaje_discapacidad, :carnet_conadis, :numero_carnet, :tipo_discapacidad, :idpais_nacionalidad, :idcanton_nacimiento, :idpais_residencia, :idcanton_residencia, :numero_celular, :tipo_colegio, :ocupacion, :ingresos, :bono_desarrollo, :nivel_formacionp, :nivel_formacionm, :ingresos_hogar, :miembros_hogar, :doc_cedula, :doc_titulo, :foto)");
