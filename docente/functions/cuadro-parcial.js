...
cmbIdCarrera.addEventListener("change", async function(){
  ...
  if(cmbIdCarrera.value != "") {
    await axios.post('https://appit.itsup.edu.ec/docente/nivel/findnivelidperiodotutor/', {
        idperiodo,
        iddocente
    })
    .then(function (res){
...
cmbNivel.addEventListener('change', async function () {
  ...
  if(cmbNivel.value != "") {
    await axios.post('https://appit.itsup.edu.ec/docente/seccion/findseccionidperiodotutor/', {
      idperiodo,
      iddocente,
      idcarrera,
      idnivel
...
cmbIdSeccion.addEventListener('change', async function () {
  ...
  if(cmbIdSeccion.value != "") {
    await axios.post('https://appit.itsup.edu.ec/docente/modalidad/findmodalidadidperiodotutor/', {
        idperiodo,
        iddocente,
        idcarrera,
        idnivel,
...
btnMostrar.addEventListener("click", async function(){
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/cuadroparcial/findmaterias/', {
    idperiodo,
    idcarrera,
    idnivel,
    idseccion,
