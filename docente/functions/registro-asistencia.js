...
window.onload = async function(){
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/docente/finddocentemateria/', {
    idperiodo,
    iddocente
  })
  .then(function (res){
...
cmbMateria.addEventListener('change', async function () {
  ...
  if(cmbMateria.value != "") {
    await axios.post('https://appit.itsup.edu.ec/docente/registroasistencia/viewlistaestudiantemateria/', {
      idperiodo,
      iddocente,
      idmateria,
      fecha
...
btnGuardar.addEventListener('click', async function (){
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/leccionario/insert/', {
    idperiodo,
    idmateria,
    fecha,
    unidad,
...
async function cargaContenido()
{
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/leccionario/validaasistenciafecha/', {
    idperiodo,
    idmateria,
    fecha
  })
...
async function asistencia(val)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/registroasistencia/actualizaasistencia/', {
    idperiodo,
    idmateria,
    idmatricula,
    fecha,
...
async function eliminaAsistencia()
{
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/registroasistencia/eliminaasistencia/', {
    idperiodo,
    idmateria,
    fecha
  })
