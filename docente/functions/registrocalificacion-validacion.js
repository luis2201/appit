...
cmbIdCarrera.addEventListener("change", async function(){
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/nivel/findnivelvalidacion', {
        idperiodo,
        idcarrera
    })
    .then(function (res){
...
cmbNivel.addEventListener("change", async function(){
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/materia/findmateriasvalidacion', {
        idperiodo,
        idcarrera,
        idnivel
    })
...
btnMostrar.addEventListener("click", async function(){
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/estudiante/findestudianteidmateriavalidacion/', {
    idperiodo,
    idmateria
  })
  .then(function (res){   
...
async function total(input) 
{
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/registrocalificacionvalidacion/save/', {
        idperiodo,
        idmatricula,
        idcarrera,
        idnivel,
