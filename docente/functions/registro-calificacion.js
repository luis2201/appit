...
window.onload = async function(){  
  await axios.post('https://appit.itsup.edu.ec/docente/docente/finddocentemateriapresencial/', {
    idperiodo,
    iddocente
  })
  .then(function (res){
...
async function total(input)
{
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/registrocalificacion/insertcalificacion/', {
    idperiodo,
    idmatricula,    
    idmateria,
    idparcial,
