...
btnMostrar.addEventListener("click", async function (){
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/finddatos/', {
        idperiodo,
        iddocente,
        idmateria
    })
...
btnAgregarEstructura.addEventListener("click", async function(){  
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/save/', {
        idperiodo,
        iddocente,
        idcarrera,
        idnivel,
    ...
    .then(async function (res){        
        ...
        if(info){            
            // let idmateria = document.getElementById("idmateria").value
            let res = await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/finddatos/', { idperiodo, iddocente, idmateria })            
            let info = res.data[0];
...
async function estructuraSyllabus(idsyllabus)
{
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/findestructura/', { 
        idsyllabus        
    })
    .then(function (res){
        let info = res.data;
...
{    
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/saveestructura/', { 
        idsyllabus,
        unidad_tematica,
        contenidos,
        horas_docencia,
...
{    
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/updateestructura/', { 
        idestructura,
        utd,
        contenidos,
        horas_docencia,
...
async function eliminaEstructura(id)
{
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/deleteestructura/', { 
        idestructura
    })
    .then(function (res){
        let info = res.data;
...
btnGuardarLogros.addEventListener("click", async function(){
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/savelogros/', { 
        idsyllabus,
        ut1,
        co1,
        lo1,
...
{       
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/findlogros/', { 
        idsyllabus        
    })
    .then(function (res){
        let info = res.data;
...
btnGuardarArticulacion.addEventListener("click", async function(){
    ...
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/savearticulacion/', { 
        idsyllabus,
...
{       
    await axios.post('https://appit.itsup.edu.ec/docente/programaanalitico/findarticulaciones/', { 
        idsyllabus        
    })
    .then(function (res){
        let info = res.data;
