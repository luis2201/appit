...
async function init()
{
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/carrera/findcarreradocentepresencial/', {
    idperiodo,
    iddocente
  })
  .then(function (res){
...
cmbIdCarrera.addEventListener('change', async function () {
  ...
  if(cmbIdCarrera.value != "") {
    await axios.post('https://appit.itsup.edu.ec/docente/docente/finddocentecarreramaterias/', {
      idperiodo,      
      iddocente,
      idcarrera
    })
...
btnMostrar.addEventListener("click", async function (){
  ...
  await axios.post('https://appit.itsup.edu.ec/docente/resumen/viewlistaestudiantemateria/', {
    idperiodo,
    idcarrera,    
    idmateria
  })
