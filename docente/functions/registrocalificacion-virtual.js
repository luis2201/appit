...
btnMostrar.addEventListener("click", async function (){
  ...
  await axios.post(DIR + 'registrocalificacionvirtual/viewlistaestudiantemateria/', {
    idperiodo,    
    idmateria,    
    idparcial
  })
...
btnImprimir.addEventListener("click", function (){ 
  ...
  var opt = {
    margin:       10,
    filename:     'RegistroCalifciacionVirtual.pdf',
...
async function total(input)
{
  ...
  await axios.post(DIR + 'registrocalificacionvirtual/insertcalificacion/', {
    idperiodo,
    idmatricula,    
    idmateria,
    idparcial,
