<?php
    ...
    class Calificacionintroductorio extends DB
    {
        public $idmatricula;
        public $idperiodo;
        public $idcarrera;
        ...
        public function validaIntroductorio($params)
        {
            $db = new DB();

            $prepare =  $db->prepare("SELECT * FROM tb_carga_horaria_introductorio WHERE iddocente = :iddocente");
            $prepare->execute($params);
