<?php
    ...
    class CalificacionintroductorioController
    {
        public function index()
        {
            view('calificacionintroductorio.index', []);
        }
        ...
        public function viewlistaestudiantemateria()
        {
            ...
            $res = Calificacionintroductorio::viewListaEstudianteMateria($param);
            foreach ($res as $row) {
                ...
                $param = [":idmatricula" => $row->idmatricula, ":idperiodo" => $idperiodo, ":idmateria" => $idmateria, ":idparcial" => $idparcial];
                $calificaciones = Calificacionintroductorio::findcalificacionidmatricula($param);
        ...
        public function insertcalificacion()
        {
            ...
            $registros = new Calificacionintroductorio();
