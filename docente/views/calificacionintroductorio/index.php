        ...
        <div class="row">         
          ...
          <div class="col-md-2">
            ...
            <select name="idparcial" id="idparcial" class="form-select">
              <option value="<?php echo Main::encryption('1'); ?>">Primer Parcial</option>
              <option value="<?php echo Main::encryption('2'); ?>">Segundo Parcial</option>
            </select>
          </div> 
        </div>
        <div class="row">
...
<script src="<?php echo DIR; ?>functions/calificacion-introductorio.js?v=1.1.4"></script>
</body>
<style>
