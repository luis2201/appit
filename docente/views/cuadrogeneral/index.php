...
<div class="container-fluid">
  ...
  <div aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Cuadro General</li>
    </ol>
  </div>
        ...
        <div class="row">
          <div class="col-md-7">
            ...
            <select name="idcarrera" id="idcarrera" class="form-select">
              ...
              $carreras = Carrera::findCarreraDocenteTutor($idperiodo, $_SESSION['idusuario_appit']);
              ...
              <div id="cuadro">
                <div class="row">
                  <div class="col-12 mb-2 text-center">
                    ...
                    <h6 style="margin-top: -10px">Periodo Académico: Noviembre 2023 - Mayo 2024</h6>
                  </div>
                </div>
...
<script src="<?php echo DIR; ?>functions/cuadro-general.js?v=1.0.1"></script>
