            ...
            <div class="card border-bottom-primary mb-2">
                ...
                <div class="card-body">
                    <div class="form-group col-12">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="tipodocumento" class="form-label">Tipo de identificación</label>
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="row mb-2">
                            ...
                            <div class="col-md-3">
                                <label for="idcanton_nacimiento">Provincia de Sufragio</label>
                            ...
                            <div class="col-md-3">
                                <label for="idcanton_residencia">Teléfono Domicilio</label>
                                <input type="text" class="form-control" id="numero_celular" name="numero_celular">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                        <div class="col-md-8">
                                <label for="numero_celular">Dirección Domiciliaria</label>
                                <input type="text" class="form-control" id="numero_celular" name="numero_celular">
                            </div>
                            <div class="col-md-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-3">
                                <label for="tipo_sangre">Enfermedad Catastrófica</label>
                                <div class="form-check">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="carnet_conadis" id="carnet_conadisSI" value="1">
                                        <label class="form-check-label" for="inlineRadio1">Si</label>
            ...
            <div class="card border-bottom-success mb-2">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-2">
                                <label for="bono_desarrollo">Cursa Estudios</label>
                                <div class="form-check">
                                    <div class="form-check form-check-inline">
                            ...
                            <div class="col-md-6">
                                <label for="ocupacion">Institución de Estudios</label>
                            ...
                            <div class="col-md-6">
                                <label for="ocupacion">País de Estudios</label>
                                <select class="form-control" name="ocupacion" id="ocupacion">
                                    <option value="">-- Seleccione ocupación --</option>
                                    <option value="TRABAJA">TRABAJA</option>
                                    <option value="NO TRABAJA">NO TRABAJA</option>
                            ...
                            <div class="col-md-4">
                                <label for="ingresos">Título a Obtener</label>
                                <input type="number" class="form-control" id="ingresos" name="ingresos">
                            </div>
                            <div class="col-md-2">
                                <label for="bono_desarrollo">Beca</label>
                                <div class="form-check">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bono_desarrollo" id="bono_desarrolloSI" value="1">
                                        <label class="form-check-label" for="inlineRadio1">Si</label>
                            ...
                            <div class="col-md-4">
                                <label for="ingresos">Monto de Beca</label>
                                <input type="number" class="form-control" id="ingresos" name="ingresos">
                            </div>
                            <div class="col-md-4">
                                <label for="nivel_formacionp">Financiamiento de Beca</label>
                            ...
                            <div class="col-md-2">
                                <label for="bono_desarrollo">Publicaciones</label>
                                <div class="form-check">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="bono_desarrollo" id="bono_desarrolloSI" value="1">
                                        <label class="form-check-label" for="inlineRadio1">Si</label>
                            ...
                            <div class="col-md-4">
                                <label for="ingresos">Número de Publicaciones</label>
                                <input type="number" class="form-control" id="ingresos" name="ingresos">
                            </div>
                        </div>
                    </div>
    ...
    <script src="<?php DIR; ?>functions/actualizar-datos.js"></script>
</body>
