                  ...
                  <tbody>     
                    <?php foreach($mensajes as $row): ?>
                      <tr>
                        ...
                        <td style="width:5%" class="text-center">
                          <input type="hidden" id="titulo" value="<?php echo $row->titulo; ?>">
                          <input type="hidden" id="mensaje" value="<?php echo $row->mensaje; ?>">
...
<script src="<?php echo DIR; ?>functions/mensaje.js"></script>
</body>
</html>